                        ...
                        <div class="row w-100">
                            ...
                            <div class="col-xl-3 d-flex justify-content-center">
                                ...
                                <div class="d-flex justify-content-around align-items-center">
                                    <svg width="15" height="22" viewBox="0 0 18 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <svg class="ms-3" width="20" height="25" viewBox="0 0 32 25" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
...
<nav class="navbar navbar-expand-lg p-3 nav-2">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link <?php echo Request::is('/') ? 'active' : ''; ?>" aria-current="page" href="/"><img class="mb-1 me-1" src="/home/home-icon.svg"
                            width="20px" alt="">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  <?php echo Request::is('delivery') ? 'active' : ''; ?>" aria-current="page" href="{{ route("delivery")}}"><img class="mb-1 me-1"
                            src="/home/deliveryIcon.png" width="20px" alt="">Delivery</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo Request::is('restaurants') ? 'active' : ''; ?>" aria-current="page" href="{{ route("restaurants")}}"><img class="mb-1 me-1" src="/home/shop.png"
                            width="20px" alt="">Restaurants</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " aria-current="page" href="#"><img class="mb-1 me-1"
                            src="/home/caterer.png" width="20px" alt="">Caterers</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " aria-current="page" href="#"><img class="mb-1 me-1"
                            src="/home/dine in.png" width="20px" alt="">Dine In</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " aria-current="page" href="#"><img class="mb-1 me-1"
                            src="/home/Restaurant Menu.png" width="20px" alt="">Menu</a>
                </li>
            </ul>
        </div>
        <a href="#" class="btn btn-transparent login-btn" style="padding: 10px 20px !important">Log In</a>
        <a href="#" class="btn btn-primary signup-btn" style="padding: 10px 20px !important">Sign Up</a>
    </div>
</nav>
