<section class="how_does_it_works py-50px">
    <div class="container-fluid">
        <h1 class="pb-5 mb-0" style="font-size: 43px; text-align:center">How does it work</h1>
        <div class="container ps-5 pe-5">
            <div class="row">
                <div class="col-xl-3 d-flex justify-content-center">
                    <div class="d-flex flex-column align-items-center" style="width: 18rem; background-color:transparent">
