        ...
        <div class="row">
            ...
            <div class="col-md-9 ">
                <div class="main-content">
                    <div class="main-searchbar-and-filter-button pt-md-0 pt-2">
                        ...
                        <div class="main-filter-button">
                            <img src="home/filter-icon.png" alt="">
                            Filter
                        </div>
                    </div>
                    @include("components.daily_deals")
                    @include("components.available_items")
                    @include("components.deals_and_discounts")
                    @include("components.top_brands")
